...
\pagestyle{fancy}
\lhead{Principal Component Analysis}
\chead{}
\rhead{Kellen Betts}
...
\end{enumerate}
The primary objective in this assignment is to use principal component
...
dataset. In this assignment, three cameras are capturing data of the
...
algorithm used was sufficient for the purposes of this assignment.
...
\noindent The main script (MATLAB) for this project $\mathtt{main.m}$:

\noindent %
\begin{framed}%
\input{insert/main}\end{framed}

\noindent The MATLAB script $\mathtt{loadMovie.m}$:

\noindent %
\begin{framed}%
\input{insert/loadMovie}\end{framed}

\noindent The MATLAB script $\mathtt{playMovie.m}$:

\noindent %
\begin{framed}%
\input{insert/playMovie}\end{framed}

\noindent The MATLAB script $\mathtt{plotProjections.m}$:

\noindent %
\begin{framed}%
\input{insert/plotProjections}\end{framed}

\noindent The MATLAB script $\mathtt{plotShifted.m}$:

\noindent %
\begin{framed}%
\input{insert/plotShifted}\end{framed}

\noindent The MATLAB script $\mathtt{plotTracking.m}$:

\noindent %
\begin{framed}%
\input{insert/plotTracking}\end{framed}

\noindent The MATLAB script $\mathtt{targetColor.m}$:

\noindent %
\begin{framed}%
\input{insert/targetColor}\end{framed}
